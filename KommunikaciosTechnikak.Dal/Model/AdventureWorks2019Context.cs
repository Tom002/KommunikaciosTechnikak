...
namespace KommunikaciosTechnikak.Dal.Model
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder
                    .UseSqlServer("Data Source=localhost;Initial Catalog=AdventureWorks2019;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False", x => x.UseNetTopologySuite())
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VProductAndDescription>(entity =>
            {
                ...
                entity.Property(e => e.CultureId).IsFixedLength(true);
            });
            ...
            modelBuilder.Entity<VStateProvinceCountryRegion>(entity =>
            {
                ...
                entity.Property(e => e.StateProvinceCode).IsFixedLength(true);
            });
